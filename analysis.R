...
predictor_order_hetro <- best_hetro$Predictor_Order
neurons_hetro <- best_hetro$Neurons
activation_func_htero <- best_hetro$Activation_Function
learning_rate_hetro <- best_hetro$Learning_Rate
